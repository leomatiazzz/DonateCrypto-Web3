...
export default function Donate() {
  ...
  function btnDonateClick() {
    ...
    donate(campaign.id, donation)
      .then((tx) => {
        setMessage(
          "Doação realizada, obrigado! Em alguns segundos o saldo será atualizado."
        );
        setDonation(0);
      })
      .catch((err) => {
  ...
  return (
    <>
      <div className="container">
        ...
        <p>
          Verifique se esta campanha é a correta antes de finalizar a sua doação
        </p>
        <hr />
        <div className="row flex-lg-row-reverse align-items-center g-5">
          ...
          <div className="col-5 mb-5" style={{ heigh: 480, scrollbars: true }}>
            ...
            <p className="mb-3 fst-italic mt-5">
              ...
              {Web3.utils.fromWei(campaign.balance || 0, "ether")} POL nesta
              campanha. O quanto você quer doar (em POL)?
            </p>
            <div className="mb-3">
