...
export default function Create() {
  ...
  function btnSaveClick() {
    ...
    addCampaign(campaign)
      ...
      .then((id) =>
        setMessage(
          `Campanha foi salva com o ID ${id}. Em alguns segundos ela estará pronta para receber doações. Use esse link para divulgá-la: http: http://localhost:3000/donate/${id}`
        )
      )
      .catch((err) => {
        console.error(err);
      ...
      <div className="container">
        ...
        <div className="col-6">
          ...
          <div className="col-12 mb-3">
            <button
              type="button"
              className="btn btn-primary col-12 pt-3"
